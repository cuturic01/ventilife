...
public class WebSecurityConfig {
    ...
    public DaoAuthenticationProvider authenticationProvider() {
        ...
        // da bi adekvatan hash koji dobije kao rezultat hash algoritma uporedio sa onim koji se nalazi u bazi
        // (posto se u bazi ne cuva plain lozinka)
    ...
    // Injektujemo implementaciju iz TokenUtils klase kako bismo mogli da koristimo njene metode za rad sa JWT u
    // TokenAuthenticationFilteru
    @Autowired
